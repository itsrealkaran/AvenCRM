...
const SideNavBar:React.FC<val> = ({current}) => {
  return (
               ...
               <div className=' w-full mt-[40px] h-fit flex flex-col gap-2 '>
                              ...
                              {[{heading:"dashboard" , icons:FaKey , reff:"/admindashboard", status : current === "AdminDashboard" } , {heading:"Company" , icons:FaKey , reff:"/admindashboard/company", status : current === "company" } ,{heading:"calender" , icons:BsCalendar2Date , reff:"/admindashboard/calender" , status : current === "calender"} , {heading:"crash report" , icons:CiUser , reff:"/admindashboard/crashReport" , status : current === "crash Report"} ,   {heading:"payments" , icons:CiWallet , reff:"/admindashboard/payment" , status : current === "payment"} , {heading:"Email" , icons:CiWallet , reff:"/admindashboard/email"} ,{heading:"Settings" , icons:CiSquareQuestion, reff:"/admindashboard/settings" ,  status : current === "settings"} ].map((e,i)=>(
