      ...
      <div className='bg-white w-full'>
        {/* this is the top level filter div  */}
          <div className='w-full px-4 flex justify-between  items-center pt-5'>
                                                                           ...
                                                                           <div className='text-[1rem] font-bold tracking-tight opacity-90'>Transaction Records</div>

                                                                           <div className='flex gap-4 text-[1rem] items-center  '>

                                                                            <div onClick={()=>openadd()} className='bg-[#5932EA] text-white px-4 text-sm py-1  tracking-tight rounded-[4px] '>
                                                                              <button>Add</button>
                                                                            </div>
          ...
          {/* this is the option designation div  */}
            ...
            <div className='w-full flex justify-between pl-20  pr-16 pb-5 items-center   mt-10 text-sm'>
