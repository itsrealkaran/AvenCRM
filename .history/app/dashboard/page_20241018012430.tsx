    ...
    <div className='w-full h-screen flex bg-[#fafbff]'>
               <div className='h-full w-[18%] bg-white shadow-xl shadow-black/20 pt-10 px-8'>
                              ...
                              <div className=' w-full mt-20 h-fit flex flex-col '>
                                             ...
                                             {[{heading:"dashboard" , icons:FaKey} ,{heading:"calender" , icons:BsCalendar2Date} , {heading:"crash report" , icons:CiUser} ,   {heading:"payments" , icons:CiWallet} , {heading:"Email" , icons:CiWallet} ,  ]}
