...
const page = () => {
  return (
    <div className='w-full h-screen flex bg-[#fafbff]'>
               <div className='h-full w-[17%] bg-white shadow-xl shadow-black/20 pt-10 px-8'>
                              ...
                              <div className=' w-full mt-20 h-fit flex flex-col '>
                                             ...
                                             <div className='w-full flex justify-between items-center opacity-45 h-fit'>
                                                            {/* inner div for the logo and text  */}
                                                                           <div className='w-1/2 capitalize h-full font-semibold  flex gap-2  items-center'>          

                                                                           {/* this is the svg container */}

                                                                                          <div className='text-[1.2rem] '><FaKey/></div>
                                                                                          <h1 className='text-[1.1rem]'>dashboard</h1>
                                                                           </div>
