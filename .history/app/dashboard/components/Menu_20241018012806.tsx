...
const Menu = ({icons : Icon , heading}) => {
  return (
               <div className='w-full flex justify-between  py-1 rounded-[9px] px-1 items-center hover:bg-[#5932ea] hover:opacity-100 hover:text-white opacity-45 h-fit'>
               {/* inner div for the logo and text  */}
                              ...
                              {/* this is the svg container */}
                                             ...
                                             <div className='text-[1.25rem] '>{Icon && <Icon />}</div>
