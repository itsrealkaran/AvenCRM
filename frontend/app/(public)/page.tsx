        ...
        <div className="px-6 lg:px-8 py-24 sm:py-32">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto">
              Streamline customer relationships, boost productivity, and drive growth with our powerful CRM solution.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 sm:py-32">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">Manage your entire business operations from a single dashboard</p>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">Powerful tools to manage clients and boost your productivity</p>
              <span className="inline-flex items-center text-primary group-hover:gap-1.5 transition-all">
                Learn more <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" />
              </span>
            </Link>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">Complete control over your organization's CRM system</p>
              <span className="inline-flex items-center text-primary group-hover:gap-1.5 transition-all">
                Learn more <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" />
              </span>
            </Link>
