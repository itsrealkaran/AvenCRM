...
import { AvailableChartColors, AvailableChartColorsKeys, getYAxisDomain } from '../lib/chartUtils';
...
const renderShape = (
  ...
  return (
    <rect
      ...
      height={height}
      className={cx(
        value >= 0 ? 'fill-emerald-600 dark:fill-emerald-500' : 'fill-rose-600 dark:fill-rose-500'
      )}
      opacity={
...
interface BarChartProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  enableLegendSlider?: boolean;
  tickGap?: number;
  barCategoryGap?: string | number | null;
  xAxisLabel?: string;
  yAxisLabel?: string;
