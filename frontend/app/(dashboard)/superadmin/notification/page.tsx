...
import { Calendar, Mail, CheckSquare, ArrowUpDown, Search, RefreshCw } from "lucide-react"
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50">
                  ...
                  <TableHead>
                    <Button variant="ghost" onClick={() => handleSort("title")} className="font-medium -ml-4">
                      Title
                  ...
                  <TableHead>
                    <Button variant="ghost" onClick={() => handleSort("timestamp")} className="font-medium -ml-4">
                      Time
                      <ArrowUpDown className="ml-2 h-4 w-4" />
                    </Button>
                  </TableHead>
                ...
                <TableBody>
                  {filteredAndSortedActivities.map((activity) => (
                    <TableRow key={activity.id} className="hover:bg-gray-50">
                      <TableCell>
                        <div className={`${getIconColor(activity.type)}`}>{getIconByType(activity.type)}</div>
                      </TableCell>
                      <TableCell className="font-medium">{activity.title}</TableCell>
                      <TableCell className="hidden md:table-cell text-gray-500">{activity.subtitle}</TableCell>
