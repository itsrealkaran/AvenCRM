...
export default function CompaniesPage() {
  ...
  const getStatusText = (company: Company) => {
    ...
    const planEndDate = new Date(company?.planEnd)
    const sevenDaysFromNow = new Date(currentDate.getTime() + 7 * 24 * 60 * 60 * 1000)
    return planEndDate > currentDate ? "Active" : planEndDate > sevenDaysFromNow ? "Overdue" : "Inactive"
  }
    ...
    <div className="h-full w-full">
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">Manage companies and their subscriptions</p>
            </div>
          </div>
        </CardHeader>
                      ...
                      <TableRow key={company.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            ...
                            <span>{admins.find((admin) => admin.id === company.adminId)?.name || "N/A"}</span>
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="flex flex-col">
                        ...
                        <TableCell>
                          <Badge variant="secondary" className={`${getStatusColor(company)} px-2 py-1`}>
      ...
      <Dialog open={isDetailsDialogOpen} onOpenChange={setIsDetailsDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold">{selectedCompanyDetails?.name}</DialogTitle>
          </DialogHeader>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{selectedCompanyDetails?.website || "N/A"}</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">
                    ...
                    -{selectedCompanyDetails?.planEnd && new Date(selectedCompanyDetails.planEnd).toLocaleDateString()}
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">
                    {admins.find((admin) => admin.id === selectedCompanyDetails?.adminId)?.name || "N/A"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <Badge variant="secondary" className={`${getStatusColor(selectedCompanyDetails as Company)} px-2 py-1`}>
