    ...
    <div className='w-full h-fit  flex pb-5'>
      ...
      <div className='w-1/2 h-full pr-12 border-r-[3px] border-black/10 '>
        ...
        <div className='w-full uppercase  tracking-tight mt-5 text-sm'>
          <p className='font-semibold  text-[10px] opacity-80'>Username</p>
          <input
            className='outline-none bg-transparent mt-2 w-full border-b-[1px] border-black/50 border-dashed'
            type='text'
            placeholder='NikoChan256'
          />
        </div>
        ...
        <div className='w-full uppercase tracking-tight text-sm mt-7'>
          ...
          <input
            className='outline-none bg-transparent w-full mt-2 border-b-[1px] border-black/50 border-dashed'
            type='text'
            placeholder='Active'
          />
        </div>
      ...
      <div className='w-1/2 h-full pl-12'>
        ...
        <div className='w-full mt-5  '>
          <p className='font-semibold pl-2 text-[14px] mb-1 '>Discription:</p>
          <div className='w-full bg-white px-2 rounded-xl py-1 '>
            {/*  this is the option div*/}
            <div className='w-full flex gap-3 '>
              {[
                { icon: CiImageOn, text: 'Image' },
                { icon: IoMdColorFilter, text: 'Color' },
                { icon: HiOutlineCodeBracket, text: 'Text' },
                { icon: FaAlignLeft, text: 'Align' },
                { icon: CiLink, text: 'Link' },
              ].map((e, i) => (
            ...
            <textarea
              className='w-full h-[28vh] mt-2 bg-[#f5f5f5] px-2 outline-none rounded-lg'
              placeholder='type..'
            ></textarea>
          </div>
        </div>
