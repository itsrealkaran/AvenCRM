    ...
    const drawCanvas = async () => {
        ...
        try {
            ...
            if (propertyImage0) {
                ...
                ctx.drawImage(img1, canvas.width * 0.4, canvas.height * 0, canvas.width * 0.6, canvas.height * 0.7)
            }
            ...
            if (propertyImage1) {
                ...
                ctx.drawImage(img1, canvas.width * 0.61, canvas.height * 0.375, canvas.width * 0.28, canvas.height * 0.24)
            }

            if (propertyImage2) {
                const img2 = await loadImage(propertyImage2)
                ctx.drawImage(img2, canvas.width * 0.61, canvas.height * 0.665, canvas.width * 0.28, canvas.height * 0.245)
            }
