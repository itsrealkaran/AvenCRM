    ...
    <div className='w-full h-[80%] flex flex-col gap-4 mt-10 '>
      <div className='flex px-10 items-center justify-between py-2 bg-[#f5f5f5] rounded-xl'>
        <div>
          ...
          <p className='text-[13px] opacity-50 font-semibold'>
            Send me email notification for every crash report
          </p>
        </div>
      ...
      <div className='flex px-10 items-center justify-between py-2 bg-[#f5f5f5] rounded-xl'>
        <div>
          ...
          <p className='text-[13px] opacity-50 font-semibold'>
            Send me email notification when someone&apos;ve mailed me
          </p>
        </div>
      ...
      <div className='flex px-10 items-center justify-between py-2 bg-[#f5f5f5] rounded-xl'>
        <div>
          ...
          <p className='text-[13px] opacity-50 font-semibold'>
            Send me email notification when someone&apos;ve sent the comment
          </p>
        </div>
