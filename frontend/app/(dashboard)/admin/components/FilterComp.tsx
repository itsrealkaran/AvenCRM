      ...
      <div className='w-[27%] rounded-3xl h-[96%] bg-white'>
        ...
        <div className='w-full h-[11%] px-5 border-b-[1px] pt-2 border-black/20 flex items-center justify-between'>
          <div className='w-1/2 leading-[1.5rem] '>
            ...
            <p className='text-[12px] opacity-70'>
              showing <span className='font-bold'>198</span> from{' '}
              <span className='font-bold'>893</span> results
            </p>
          </div>
          <div className='w-1/2 h-full flex justify-end items-center'>
            <div
              onClick={close}
              className='w-[25%] text-black text-[1.5rem] rounded-lg h-[55%] bg-blue-800/20 flex items-center justify-center'
            >
              <MdOutlineCancel />
            </div>
          </div>
        ...
        <div className='w-full h-[15%] flex items-start flex-col  mt-4 border-b-[1px] px-6 pt-2 border-black/20'>
          ...
          <div className='relative w-full'>
            <input
              className='w-full mt-2 px-4 outline-none border-[1px] border-black/30 rounded-lg py-[5px]'
              type='text'
