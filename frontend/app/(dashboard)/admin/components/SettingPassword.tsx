    ...
    <div className=' w-full h-[80%]  flex  '>
      ...
      <div className='w-[55%] border-r-[2px] pt-12 border-black/20 h-full flex flex-col gap-7'>
        <div className='w-full px-8 relative'>
          <input
            className='w-full py-2 rounded-lg text-[0.9rem] bg-white border-[1px] outline-none border-black/20 pl-12 '
            type='text'
        ...
        <div className='w-full px-8 relative'>
          <input
            className='w-full py-2 rounded-lg bg-white text-[0.9rem] border-[1px] outline-none border-black/20 pl-12 '
            type='text'
        ...
        <div className='w-full px-8 relative'>
          <input
            className='w-full py-2 rounded-lg bg-white border-[1px] text-[0.9rem] outline-none border-black/20 pl-12 '
            type='text'
      ...
      <div className='w-[45%] flex flex-col gap-5 text-sm pt-7 h-full ml-5'>
        <div className='w-full flex gap-2 items-center'>
          ...
          <p className='opacity-70 leading-[1.3rem] w-[55%]'>
        ...
        <div className='w-full flex gap-2 items-center'>
          ...
          <p className='opacity-70 leading-[1.3rem] w-[55%]'>
            Minimum 1 special letter in password like @,#,$.
          </p>
        </div>
        <div className='w-full flex gap-2 items-center'>
          <div className=' text-green-700  text-[1.8rem]  rounded-full '>
