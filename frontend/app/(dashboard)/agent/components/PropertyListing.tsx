    ...
    <>
      {openDialog ? (
        <div
          ...
          className='w-[24%] overflow-hidden flex-shrink-0 h-[49%] bg-white rounded-xl'
        >
          ...
          <div className='py-2 px-3'>
            <h1 className=' font-bold opacity-80 leading-[1.3rem]  uppercase'>
              92 allium place, orlando fl 32827{' '}
            </h1>
            <h2 className='font-bold opacity-90 text-[#4A60A1] text-[15px] leading-none mt-4'>
              $ 590,693
            </h2>
              ...
              <div className='flex items-center gap-1'>
                <div className='w-9 h-9 overflow-hidden rounded-full '>
                  <Image
                    ...
                    width={100}
                    className='w-full h-full object-cover'
                    src='https://images.pexels.com/photos/17525263/pexels-photo-17525263/free-photo-of-peach-juice-in-glasses.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load'
                    alt='not showing'
                  />
                </div>
        ...
        <>
                  ...
                  <div className='w-[49.5%] h-full overflow-hidden rounded-lg relative'>
                    <div className='w-full h-full absolute top-0 left-0  bg-black/10 flex justify-end items-center '>
                      <div
                        ...
                        className='flex gap-2 cursor-pointer text-white px-2 py-2 mr-1 bg-[#363532]/80 rounded-sm'
                      >
                        <IoMdPhotos />
                        <FaPlus />
                        <h1>27</h1>
          ...
          <div
            className={`absolute ${openImages ? 'block' : 'hidden'} top-0 left-0 w-full h-full z-20 bg-[#F6F9FE]`}
          >
