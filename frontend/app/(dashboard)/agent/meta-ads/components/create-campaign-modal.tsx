          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Tabs value={campaignType} onValueChange={(value) => setCampaignType(value as "leads" | "traffic")}>
              ...
              {campaignType === "leads" && (
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" onClick={() => setShowSelectFormModal(true)} className="flex-1">
              ...
              <div className="space-y-2">
                ...
                />
                {errors.adDescription && <p className="text-sm text-red-500">{errors.adDescription}</p>}
              </div>
