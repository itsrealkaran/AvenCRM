...
import { BarChartHeroSec } from '@/components/BarchartHeroSecond';
...
const page = () => {
  return (
    <div className='w-full px-3 py-2 h-full  bg-[#F6F9FE]'>
      {/* top level div for the total agents and revenue divs  */}

      <div className='w-full flex items-center h-[35%]   gap-2'>
        {/* this is one div  */}
      ...
      <div className='w-full rounded-xl h-[52%] bg-white border-[1px] border-black/20 mt-2'>
