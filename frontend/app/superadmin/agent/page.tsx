...
export default function MonitoringDashboard() {
  ...
  return (
    <section className='flex-1 space-y-4 p-4 md:p-8 pt-6'>
      <Card className='flex-1 space-y-4 p-4 md:p-8 pt-6'>
        ...
        <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className='space-y-4'>
          <TabsList className='grid w-full grid-cols-2 p-2 gap-2 text-2xl font-semibold'>
            <TabsTrigger value='overview' className='text-xl font-semibold'>
              Overview
            </TabsTrigger>
            <TabsTrigger value='tasks' className='text-xl font-semibold'>
              Tasks
            </TabsTrigger>
          </TabsList>
