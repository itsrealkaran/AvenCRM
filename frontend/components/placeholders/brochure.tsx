        ...
        <div className='flex-1 flex items-center justify-center'>
          <div className='text-center max-w-md mx-auto space-y-6'>
            ...
            <div className='space-y-2'>
              <h2 className='text-2xl font-semibold'>Unlock Brochure Builder</h2>
              <p className='text-muted-foreground'>
                Create professional property brochures with our advanced builder. Design, customize,
                and generate beautiful brochures instantly.
              </p>
            </div>
            ...
            {user?.role === 'ADMIN' ? (
              ...
              <Button className='w-full' onClick={handleNotifyAdmin}>
                Notify Admin
              </Button>
            )}
