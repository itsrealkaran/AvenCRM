                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                {['tarkheesi', 'property_number'].map((type) => (
                                                    <div key={type} className="relative">
                                                        ...
                                                        >
                                                            <div className={`w-3 h-3 border rounded-full mr-2 flex items-center justify-center ${field.value === type ? 'border-[#5932EA]' : ''}`}>
                                                                {field.value === type && (
                                                                    <div className="w-2 h-2 rounded-full bg-[#5932EA]" />
                                                                )}
                                                            </div>
                                                            <span className="text-sm">{type === 'tarkheesi' ? 'Tarkheesi permit' : 'Property number'}</span>
                                                        </label>
                                                    </div>
                                                ))}
                                            </div>
