...
import { ArrowLeft, ArrowRight, Building, CheckCircle, User, Award, Phone, Star } from "lucide-react"
    ...
    <div className="container mx-auto py-10 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground">Complete the form below to set up your personalized realtor portfolio</p>
        </div>
