...
const Logo: React.FC = () => (
  <svg height='0.8em' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1729.67 1508.93'>
    <defs>
      <style>{`.cls-1{fill:#5932EA;stroke:#5932EA;stroke-miterlimit:10;stroke-width:60px;}`}</style>
    </defs>
