    ...
    <div className='pt-12 pb-16 px-4'>
      ...
      >
        <div className='text-center mb-16'>
          ...
          <motion.p variants={itemVariants} className='text-lg text-[#6f6c90] max-w-2xl mx-auto'>
            Choose the plan that&lsquo;s right for you with our clear, competitive pricing. Perfect for
          ...
          >
            <span
              className={`text-sm font-medium ${!isAnnual ? 'text-[#222222]' : 'text-[#6f6c90]'}`}
            >
              Monthly
            </span>
            <Switch
        ...
        <AnimatePresence mode='wait'>
          ...
          >
            {plans.map((plan) => (
              <motion.div key={plan.type} whileHover={{ y: -5 }} className='relative'>
                <div
                ...
                >
                  ...
                  <div className='mb-6'>
                    <div className='flex gap-2'>
                      <div className='flex h-14 w-14 items-center justify-center rounded-xl bg-[#F2F1FF]'>
                        <div
                          className={`h-8 w-8 overflow-hidden ${plan.popular ? 'rounded-lg' : 'rounded-full'}`}
                        >
                      ...
                      <div>
                        <div
                          className={`text-sm mb-0.2 ${plan.popular ? 'text-white/80' : 'text-[#6f6c90]'}`}
                        >
                          {plan.description}
                        </div>
                  ...
                  <div className='space-y-6 flex-grow'>
                    <h4
                      className={`text-sm font-medium ${plan.popular ? 'text-white/90' : 'text-[#222222]'}`}
                    >
                      What&apos;s included
                    </h4>
