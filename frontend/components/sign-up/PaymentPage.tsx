  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-500">Please review your plan details and proceed to payment.</p>
      </div>
      ...
      <div className="space-y-4">
        <p className="text-sm text-gray-500">Click the button below to be redirected to our secure payment gateway.</p>
        <Button
