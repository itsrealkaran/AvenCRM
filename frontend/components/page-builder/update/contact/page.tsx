  ...
  useEffect(() => {
    ...
    if (savedData) {
      ...
      setFormData({
        ...
        contactFormDescription: parsedData.contactFormDescription || formData.contactFormDescription,
        contactFormBackgroundImage: parsedData.contactFormBackgroundImage || formData.contactFormBackgroundImage,
      })
    }
  }, [])
              ...
              <CardContent>
                <TabsContent value="content" className="space-y-6 mt-0">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      This description appears below the title and helps explain the purpose of the contact form.
                    </p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="appearance" className="space-y-6 mt-0">
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      This image will be used as the background for the contact form section. Leave empty to use the
                      default image.
                    </p>
                  </div>
