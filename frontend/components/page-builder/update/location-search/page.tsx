...
import { ArrowLeft, Save, ImageIcon, Type } from "lucide-react"
...
export default function UpdateLocationSearch({ navigateTo }: SetupFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    locationSearchDescription: "Search for properties in your desired location and connect with our expert agents.",
  ...
  useEffect(() => {
    ...
    if (savedData) {
      ...
      setFormData({
        ...
        locationSearchDescription: parsedData.locationSearchDescription || formData.locationSearchDescription,
        locationSearchBackgroundImage:
              ...
              <CardContent>
                <TabsContent value="content" className="space-y-6 mt-0">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      This description appears below the title and helps explain the purpose of the page.
                    </p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="appearance" className="space-y-6 mt-0">
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      This image will be used as the background for the hero section. Leave empty to use the default
                      image.
                    </p>
                  </div>
