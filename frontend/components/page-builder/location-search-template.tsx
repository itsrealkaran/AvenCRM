...
import { Search, MapPin, X, Mail, Phone, User, Send, ChevronDown, Home, Building, MapPinned } from "lucide-react"
            ...
            <CardContent className="p-0 overflow-hidden">
              <div className="bg-blue-600 p-6 text-white">
                ...
                <p className="text-blue-100 mt-1">
                  Tell us about your property search and we'll connect you with an expert agent.
                </p>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-blue-50 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-600">
                  Our experienced agents will guide you through every step of the buying or selling process.
                </p>
              </div>
            ...
            <div className="mt-16 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 text-sm">Schedule viewings of properties that match your criteria.</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="mb-6 text-blue-100">
                    Our team of expert real estate agents is ready to help you find the perfect property. Start your
                    search today!
                  </p>
                  <Button className="bg-white text-blue-600 hover:bg-blue-50" onClick={() => setShowContactForm(true)}>
                    Contact an Agent
                  </Button>
                </div>
