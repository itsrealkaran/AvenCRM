          ...
          {formSubmitted ? (
            <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 max-w-xl mx-auto border border-white/20'>
              ...
              <p className='text-emerald-100 mb-6'>
                Thank you for your information. You can now download any document from our resource
                center.
              </p>
              <Button
                ...
                onClick={() =>
                  window.scrollTo({
                    top: document.getElementById('document-list')?.offsetTop || 0,
                    behavior: 'smooth',
                  })
                }
              >
            ...
            <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 max-w-xl mx-auto border border-white/20'>
              ...
              <p className='text-emerald-100 mb-6'>
                Fill out a quick form to gain access to our complete collection of real estate
        ...
        {formSubmitted ? (
              ...
              <div className='flex flex-col md:flex-row gap-4 items-start md:items-center justify-between mb-6'>
                <div>
                  ...
                  <p className='text-gray-600'>
                    Find the perfect template for your real estate needs
                  </p>
                </div>
          ...
          <div className='text-center py-12'>
            ...
            <p className='text-gray-600 max-w-xl mx-auto mb-6'>
              Please complete the request form to access our document library. This helps us provide
              you with the most relevant resources.
            </p>
            <Button
  ...
  return (
    <Card className='overflow-hidden hover:shadow-lg transition-all duration-300 border-0 shadow-md group'>
      ...
      <CardContent className='p-5'>
        <h3 className='font-bold text-lg mt-1 group-hover:text-emerald-600 transition-colors'>
          {document.title}
        </h3>
      ...
      <CardFooter className='bg-gray-50 p-4 flex justify-between border-t border-gray-100'>
        ...
        <Button
          size='sm'
          className={
            canDownload ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-gray-600 hover:bg-gray-700'
          }
          onClick={onDownload}
        >
          {canDownload ? (
