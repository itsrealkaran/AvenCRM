...
import { Mail, Phone, MapPin, Clock, Send, CheckCircle, User, MessageSquare, Building } from "lucide-react"
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-600">
                      We serve the entire {contactInfo.address.city} metropolitan area and surrounding counties.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-medium text-amber-700">How quickly will I receive a response?</h4>
                    <p className="text-sm text-gray-600">
                      We typically respond to all inquiries within 2-3 business hours during normal business hours.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-medium text-amber-700">Do you offer virtual consultations?</h4>
                    <p className="text-sm text-gray-600">
